...
info() {
  printf '\033[1;34m[mac]\033[0m %s\n' "$*"
}

warn() {
  printf '\033[1;33m[mac]\033[0m %s\n' "$*"
}

fail() {
  printf '\033[1;31m[mac]\033[0m %s\n' "$*" >&2
  exit 1
}
...
ensure_ollama_installed() {
  ...
  warn "Ollama nao encontrado. Tentando instalar."
...
- Download do Ollama: https://ollama.com/download/mac
